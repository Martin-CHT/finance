...
# Find where the old logic is
start_idx = text.find('var priceSheet = getOrCreatePriceSheet();')
end_idx = text.find('return { ok: true, saved: saved };')

if start_idx != -1 and end_idx != -1:
    text = text[:start_idx] + batch_logic + '\n    ' + text[end_idx:]
